...
import { MessageCircle, Clock, Phone, MapPin, ChevronRight } from "lucide-react";
              ...
              {categories.map((category) => (
                ...
                >
                  <Button
                    ...
                    className={`whitespace-nowrap flex-shrink-0 px-6 py-2 rounded-full transition-all duration-300 ${
                          ...
                          <div className="space-y-1">
                            {(() => {
                              ...
                              if (priceData.type === 'complex') {
                                ...
                                return Object.entries(priceData.sections).map(([size, options]: [string, any[]]) => (
                                ...
                                return Object.entries(priceData.sections).map(([groupName, options]: [string, any[]]) => (
